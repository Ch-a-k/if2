...
## 📱 Telegram интеграция (НОВОЕ!)

### Получайте заявки с сайта прямо в Telegram!

✅ **Полный трекинг клиента:**
- Устройство, браузер, ОС, разрешение экрана
- Откуда пришёл (referrer, landing page)
- UTM метки (source, medium, campaign)
- Путь по сайту (какие страницы посетил)
- Время на сайте
- Геолокация (страна, город, IP)

🎛️ **Управление через Sanity Admin:**
- Меняйте токен бота и Chat ID прямо в админке
- Без редеплоя - изменения применяются сразу
- Все настройки в одном месте

**Быстрая настройка (5 минут):** `TELEGRAM_БЫСТРАЯ_НАСТРОЙКА.md`  
**Управление через админку:** `TELEGRAM_АДМИН_ПАНЕЛЬ.md`  
**Подробная инструкция:** `TELEGRAM_SETUP_GUIDE.md`
...
Сайт теперь использует **Incremental Static Regeneration** с кешированием на 1 час:
- ✅ **Быстрая загрузка** - контент кешируется
- ✅ **Экономия ресурсов** - минимум запросов к Sanity
- ✅ **Мгновенное обновление** - через webhook при Publish

**Настройка webhook:** `SANITY_WEBHOOK_SETUP.md`
...
- **`FAVICON_GUIDE.md`** - 🎨 Установка favicon (иконки сайта)
- **`НОВЫЙ_COOKIE_BANNER.md`** - 🍪 Новый компактный Cookie Banner

### SEO и Аналитика
- **`БЫСТРАЯ_НАСТРОЙКА.md`** - ⚡ Настройка GTM, Hotjar, OG Image, Favicon за 5 минут
- **`ANALYTICS_SETUP_GUIDE.md`** - 📊 Подробная настройка аналитики (GTM, Hotjar, Cloudflare)
...
### Интеграции
- **`TELEGRAM_БЫСТРАЯ_НАСТРОЙКА.md`** - 📱 Настройка Telegram бота за 5 минут
- **`TELEGRAM_АДМИН_ПАНЕЛЬ.md`** - 🎛️ Управление Telegram через Sanity Admin
- **`TELEGRAM_SETUP_GUIDE.md`** - 📱 Полное руководство по Telegram + трекинг
- **`TELEGRAM_ГОТОВО.md`** - ✅ Итоговая инструкция

### Техническая документация
- **`SANITY_WEBHOOK_SETUP.md`** - ⚡ Настройка On-Demand Revalidation (оптимизация)
- **`HOSTINGER_DEPLOYMENT.md`** - 🚀 Деплой на Hostinger + привязка домена
...
### Что уже настроено:
- ✅ **Google Tag Manager** - управление через Sanity CMS
- ✅ **Hotjar** - Site ID: 6543563 (готов к использованию)
- ✅ **Cloudflare Analytics** - поддержка добавлена
- ✅ **OG метатеги** - автоматически из Sanity
- ✅ **Twitter Cards** - поддержка
- ✅ **Favicon** - настроен (замените на свой)

### Что нужно сделать:

1. **Откройте Sanity Studio** → **⚙️ Settings** → **Site Settings**
2. Заполните:
   - Site Title
   - Site Description (макс 160 символов)
   - Загрузите OG Image (1200x630px)
   - Добавьте GTM ID (если есть)
3. **Замените favicon** в `/public/`:
   - `favicon.ico` (32x32px)
   - `favicon.svg` (векторный)
   - `apple-touch-icon.png` (180x180px)

⚡ **Быстрая настройка:** см. `БЫСТРАЯ_НАСТРОЙКА.md` (5 минут)
