      ...
      <div className={styles.container}>
        ...
        <div className={styles.content}>
          ...
          <div className={styles.brandColumn}>
            ...
            <div className={styles.socials}>
              <a 
                href="https://twitter.com/in_4omo" 
                target="_blank" 
              ...
              <a 
                href="https://linkedin.com/company/in-fomo" 
                target="_blank" 
                rel="noopener noreferrer"
                className={styles.socialLink}
                aria-label="LinkedIn"
              ...
              <a 
                href="https://instagram.com/in_fomo" 
                target="_blank" 
                rel="noopener noreferrer"
                className={styles.socialLink}
          ...
          <div className={styles.navColumn}>
            ...
            <nav className={styles.navLinks}>
              <Link href="/works">Web Development</Link>
              <Link href="/works">Mobile Apps</Link>
              <Link href="/works">UI/UX Design</Link>
              <Link href="/works">Blockchain</Link>
              <Link href="/works">Consulting</Link>
            </nav>
          </div>
          ...
          <div className={styles.navColumn}>
            ...
            <nav className={styles.navLinks}>
              ...
              <Link href="https://clutch.co/profile/fomo-0" target="_blank" rel="noopener noreferrer">
                Clutch Profile
              </Link>
            </nav>
          </div>
        ...
        <div className={styles.bottom}>
          <p className={styles.copyright}>
            © {currentYear} IN-FOMO. All Rights Reserved.
          </p>
